...
export default function Card(card: Props) {
    return (
        <div className="m-10 flex h-[35rem] w-11/12  flex-col gap-8 rounded-[3rem] border-2 border-base-200 bg-white p-8 first:bg-primary first:text-white md:border-0 ">
