                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center justify-center gap-2">
                                <span className="opacity-60">{day.weekday}</span>
                                <p
                                    className={`${day.today ? 'flex h-6 w-6  items-center justify-center rounded-full bg-primary p-3 text-white' : 'opacity-60'}`}
                                >
                                    {day.date.format('D')}
                                </p>
                            </div>
